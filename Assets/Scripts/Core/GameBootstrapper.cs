...
namespace Game.Core
{
    // Точка входа. Оптимально для не тестового задания было бы заменить его, например, MonoInstaller'ом,
    // но для тестового задания лучше не раздувать кодовую базу и упростить его проверку
        ...
        : MonoBehaviour
    {
        ...
        private void HandleKill(KillSignal _)
        {
            ...
            Debug.Log($"Kills: {_kills}/{_killsToWin}");
